## How to Fine-tune DeepCode-AI

We provide script `finetune_deepcodeai.py` for users to finetune our models on downstream tasks.
...
MODEL_PATH="deepcode-ai/deepcode-ai-6.7b-instruct"

deepspeed finetune_deepcodeai.py \
