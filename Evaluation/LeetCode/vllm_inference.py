...
def generate_main(data_path: str, model_name_or_path: str, saved_path: str, model_type: str='deepcodeai-instruct', cot: bool=False):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_name_or_path', type=str, default='deepcode-ai/deepcode-ai-7b-instruct')
    parser.add_argument('--saved_path', type=str, default=f'output/{version}.deepcode-ai-7b-instruct.jsonl')
